#github: https://github.com/xiongm027/DSC-590Capstone
...
<br><br>Correlation Matrix
<br>Shows the relationship between variables in a dataset. Helps identify how strong two variables, a +1 indicates a perfect positive relationship, a -1 indicates a perfect negative relationship, a 0 indicates no relationship. A high correlation in some models can cause instability in the prediction. 

<br><br>Summary Statistics
<br>Provides an overview of the dataset, includes the following:
<br> Measures of Central Tendency: Mean, Median, Mode
<br> Measures of Spread: Standard Deviation, Variance, Range, Interquartile (how data is distributed)
<br> Min & Max Values: Identifies boundaries of the data
<br> Skewness & Jurtosis: Shape of the datas distribution, is there a large group of one data compared to others. 
